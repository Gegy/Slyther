...
public enum SkinHandler {
    ...
    SkinHandler() {
        ...
        PATTERNS.put(Skin.ARCADE_GO, new SkinDetails(new SkinColor[] { LIGHT_BLUE_6, LIGHT_BLUE_6, LIGHT_BLUE_6, LIGHT_BLUE_6, LIGHT_BLUE_6, LIGHT_BLUE_6, LIGHT_BLUE_6, LIGHT_BLUE_6, LIGHT_BLUE_6, LIGHT_YELLOW_2, LIGHT_YELLOW_2, LIGHT_YELLOW_2, LIGHT_YELLOW_2, LIGHT_YELLOW_2, LIGHT_YELLOW_2, LIGHT_YELLOW_2, LIGHT_YELLOW_2, LIGHT_YELLOW_2 }, true, 8, 0x00688C, 0x64C8E7, 1.0F, 0.75F, 0xFFFFFF, false, 0.35F, true, false, 2.3F, 0.0F, "red_antenna"));
        PATTERNS.put(Skin.ORANGE_PURPLE_STRIPE_ANTENNA, new SkinDetails(new SkinColor[] {  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  DARK_PURPLE,  ORANGE,  ORANGE,  ORANGE,  ORANGE,  ORANGE,  ORANGE,  ORANGE,  ORANGE, ORANGE }, true, 9, 0x000000, 0x5630D7, 1.0F, 1.0F, 0xFF5609, true, 1, false, false, 2.3F, 0.0F, "orange_block"));
        PATTERNS.put(Skin.SILVER_GOLD_OUTLINE, new SkinDetails(new SkinColor[] { GRAY_2 }));
        PATTERNS.put(Skin.GREEN_EYEBALL, new SkinDetails(new SkinColor[] { GREEN }, false, 0, 0, 0, 1.0F, 0.75F, 0xFFFFFF, false, 0.0F, false, true, 4.0F, 0.06F, ""));
        ...
        PATTERNS.put(Skin.BRIGHT_ORANGE, new SkinDetails(new SkinColor[] { ORANGE }, true, 9, 0x301400, 0xFF6813, 1.5F, 1.0F, 0xFFFFFF, true, 0.5F, true, false, 2.3F, 0.0F, "bright_orange_antenna"));
        PATTERNS.put(Skin.BRIGHT_YELLOW, new SkinDetails(new SkinColor[] { LIGHT_YELLOW_2 }));
        PATTERNS.put(Skin.PEWDIEPIE, new SkinDetails(new SkinColor[] { LIGHT_BLUE_6 }, true, 9, 0x1D3245, 0x44D4FF, 1.0F, 1.0F, 0xFFFFFF, true, 0.43F, true, false, 2.3F, 0.0F, "pewdie_pie_antenna")); //TODO
        PATTERNS.put(Skin.JELLY, new SkinDetails(new SkinColor[] { LUMO_GREEN }, "jelly"));
