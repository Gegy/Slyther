...
public class ButtonElement extends Element {
    ...
    public void render(float mouseX, float mouseY) {
        ...
        gui.drawRect(posX + 16.0F, posY, effectiveWidth - 16.0F, height, selected ? 0x3A7E5C : 0x489E73);
        gui.drawRect(posX, posY + 16.0F, width, effectiveHeight, selected ? 0x3A7E5C : 0x489E73);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
